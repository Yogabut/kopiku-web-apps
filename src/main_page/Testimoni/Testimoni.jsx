    ...
    return (
        <div className="flex items-center">
            {[...Array(5)].map((_, index) => (
                <svg
                    key={index}
                    className={`w-5 h-5 ${index < rating ? 'text-[#e4bb7c]' : 'text-gray-400'}`}
...
const TestimonialCard = ({ testimonial }) => {
    return (
        <div className="flex flex-col overflow-hidden shadow-xl min-w-[300px] max-w-sm mx-4">
            <div className="flex flex-col justify-between flex-1 p-6 bg-[#2F5249] hover:bg-[#203832] rounded-2xl lg:py-8 lg:px-7 transition duration-300 min-h-[320px]">
            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="flex flex-col items-center">
                    <div className="text-center">
                        <p
                        className="text-lg font-medium text-gray-700 font-pj"
                        data-aos="zoom-in"
                        ...
                        <h2 
                        className="mt-4 text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl font-serif font-pj"
                        data-aos="zoom-in"
                        data-aos-duration="1000"
                        data-aos-delay="200">
